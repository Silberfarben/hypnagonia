...
var descriptions := {
	...
	"Pre-Dawn": "It was the pain of a hot sauce constantly dripping into my open mouth, the repeating of an annoying jingle until it lost all meaning. My whole body felt the wet clapping and cracking of wet leater an bones. I knew then that, for better of worse, it would happen again. ", 
}
